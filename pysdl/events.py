...
_funcdefs = [
    ...
    SDLFunc("SDL_PeepEvents", [_P(SDL_Event), c_int,
            SDL_eventaction, Uint32, Uint32], c_int),
    ...
    SDLFunc("SDL_GetEventFilter", [
            _P(SDL_EventFilter), _P(c_void_p)], SDL_bool),
...
def SDL_GetEventState(t): return SDL_EventState(t, SDL_QUERY)
